...
export default function Hero() { 
    ...
    return (
        <div id="home" className="text-white w-full h-full mt-16 static overflow-hidden">
          ...
          {/* Overlay Content */}
          <div className="absolute top-28 md:top-20 lg:top-20 left-1/2 transform -translate-x-1/2 md:py-20 md:pt-8 h-full flex flex-col items-center text-center">
        <div className="text-4xl md:text-6xl lg:text-7xl lg:mt-2 md:mt-[-4] font-bold leading-tight">
        ...
        >
          <p
            className="font-semibold text-lg md:text-2xl lg:text-3xl text-white mb-8 md:mb-36 lg:mb-64 xl:mb-8 mt-2 md:mt-3 
          lg:mt-4 md:pb-6 backdrop-blur-sm md:backdrop-blur-sm lg:backdrop-blur-none"
          >
